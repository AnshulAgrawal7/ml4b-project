...
[![Open in Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://gym-exercise-recognition.streamlit.app/)

**Live demo (runs in your browser, no install): [gym-exercise-recognition.streamlit.app](https://gym-exercise-recognition.streamlit.app/)** — or run it locally with the one-command [Quickstart](#quickstart--one-command) below.
